WIP Lerna + Yarn Workspaces monorepo of various UI components and NPM modules.
...
2. [React pagination](https://github.com/unleashit/npm-library/tree/master/packages/pagination) - responsive pagination component for React.
